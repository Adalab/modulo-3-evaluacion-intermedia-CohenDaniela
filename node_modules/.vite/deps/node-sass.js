...
var require_true_case_path = __commonJS({
  "node_modules/true-case-path/index.js"(exports, module) {
    "use strict";
    var { readdir: _readdir, readdirSync } = require_fs();
    var { platform } = require_os();
    var { isAbsolute, normalize } = require_path();
    var { promisify: pify } = require_util();
    var readdir = pify(_readdir);
    ...
    function iterateSync(basePath, filePath, segments) {
      return segments.reduce(
        (realPath, fileOrDirectory) => realPath + delimiter + matchCaseInsensitive(
          fileOrDirectory,
    ...
    async function iterateAsync(basePath, filePath, segments) {
      return await segments.reduce(
        async (realPathPromise, fileOrDirectory) => await realPathPromise + delimiter + matchCaseInsensitive(
          fileOrDirectory,
...
var require_package = __commonJS({
  "node_modules/node-sass/package.json"(exports, module) {
    module.exports = {
      name: "node-sass",
      version: "9.0.0",
      libsass: "3.5.5",
...
var require_extensions = __commonJS({
  "node_modules/node-sass/lib/extensions.js"(exports, module) {
    var eol = require_os().EOL;
    var fs = require_fs();
    var path = require_path();
    var trueCasePathSync = require_true_case_path().trueCasePathSync;
    var pkg = require_package();
    var defaultBinaryDir = path.join(__dirname, "..", "vendor");
...
var require_errors = __commonJS({
  "node_modules/node-sass/lib/errors.js"(exports, module) {
    var sass = require_extensions();
    var pkg = require_package();
...
var require_binding = __commonJS({
  "node_modules/node-sass/lib/binding.js"(exports, module) {
    ...
    module.exports = function(ext) {
      ...
      return __require(ext.getBinaryPath());
    };
  }
});
...
var require_lib = __commonJS({
  "node_modules/node-sass/lib/index.js"(exports, module) {
    var path = require_path();
    var clonedeep = require_cloneDeep();
    var sass = require_extensions();
    var binding = require_binding()(sass);
    ...
    function getOptions(opts, cb) {
      ...
      options.context = { options, callback: cb };
      options.result = {
    ...
    function normalizeFunctionSignature(signature, callback) {
      if (!/^\*|@warn|@error|@debug|\w+\(.*\)$/.test(signature)) {
        ...
        return {
          signature: signature + "(...)",
          callback: function() {
            var args = Array.prototype.slice.call(arguments), list = args.shift(), i;
    ...
    module.exports.render = function(opts, cb) {
        ...
        if (Array.isArray(importer)) {
          ...
          importer.forEach(function(subject, index) {
            options.importer[index] = function(file, prev, bridge) {
              function done(result2) {
                bridge.success(result2 === module.exports.NULL ? null : result2);
              }
      ...
      if (functions) {
        ...
        Object.keys(functions).forEach(function(subject) {
          var cb2 = normalizeFunctionSignature(subject, functions[subject]);
          options.functions[cb2.signature] = function() {
            var args = Array.prototype.slice.call(arguments), bridge = args.pop();
            function done(data) {
              bridge.success(data);
            }
            var result = tryCallback(cb2.callback.bind(options.context), args.concat(done));
            if (result) {
              done(result);
            }
          };
        ...
        if (Array.isArray(importer)) {
          ...
          importer.forEach(function(subject, index) {
            options.importer[index] = function(file, prev) {
              var result2 = subject.call(options.context, file, prev);
              return result2 === module.exports.NULL ? null : result2;
            };
          });
        } else {
          options.importer = function(file, prev) {
            var result2 = importer.call(options.context, file, prev);
            return result2 === module.exports.NULL ? null : result2;
          };
        }
      }
